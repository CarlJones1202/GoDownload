...
func main() {
	targetUrls := []string{
		// "https://vipergirls.to/threads/13637802-Elly-Clutch-Insatiable-1-120-pictures-8192px-(10-Feb-2025)?highlight=Elly+Clutch",
		// "https://vipergirls.to/threads/13604263-PlayboyPlus-com-Elly-Clutch-And-Kei-Winning-Team-(Feb-07-2025)?highlight=Elly+Clutch",
		// "https://vipergirls.to/threads/12070471-Elly-Clutch-Presenting-Elly-Clutch-120-pictures-8192px-(8-Oct-2024)?highlight=Elly+Clutch",
		// "https://vipergirls.to/threads/10629291-Elly-Clutch-in-Shifting-Gears-x37-5222x5296px-04-03-2024?highlight=Elly+Clutch",
		// "https://vipergirls.to/threads/10629305-Elly-Clutch-in-Spring-Tea-x37-5462x4917px-04-10-2024?highlight=Elly+Clutch",
		// "https://vipergirls.to/threads/10586502-Elly-Clutch-Green-with-Frenzy-48-pictures?highlight=Elly+Clutch",
		// "https://vipergirls.to/threads/10449253-Elly-Clutch-April-Pet-Stripteases?highlight=Elly+Clutch",
		// "https://vipergirls.to/threads/10396703-Elly-Clutch-Pet-of-the-Month-March-2024-48-pictures?highlight=Elly+Clutch",
		// "https://vipergirls.to/threads/13602043-Serena-Wood-Sweet-Serena-x122-(02-07-25)",
		// "https://vipergirls.to/threads/13684957-Hannah-Le-Tavia-Lollygag-1-120-pictures-8192px-(16-Feb-2025)?p=222447955&viewfull=1#post222447955",
...
func DownloadGallery(targetUrl string, title string) {
	...
	directory := "C:\\Users\\carlj\\Downloads\\go\\" + sanitizeFolderName(path.Base(u.Path))
